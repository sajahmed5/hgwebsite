  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        ...
        {/* Mobile / tablet quick actions — always visible in the bar */}
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <Link
            href="/contact"
            className="rounded-full bg-accent-500 px-3 py-1.5 text-xs font-semibold text-white shadow-sm"
          >
            Request care
          </Link>
          <button
            ...
            aria-expanded={open}
            className="inline-flex items-center justify-center rounded-lg p-1.5 text-brand-800 hover:bg-brand-50"
          >
